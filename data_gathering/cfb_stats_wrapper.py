...
def pull_games_data(year: int, start_week: int, end_week: int):
    """
    Pulls all of the games data from start week to end week for a given year.
    This function will check to see if data already exists for a given, game, week, 
    and year combination before pulling data and adding it to the database.
    It saves all the data pulled into the postgres database.
